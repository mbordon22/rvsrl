...
namespace App\DataTables\CargasCombustible;
...
class CargaCombustibleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('vehiculo_id', function ($row) {
                return $row->vehiculo ? $row->vehiculo->marca . ' ' . $row->vehiculo->modelo . ' - '. $row->vehiculo->identificador_vehiculo : 'N/A';
            })
    ...
    {
        return [
            Column::make('vehiculo_id')
                  ->title('Vehículo - Identificador')
                  ->searchable(false)
                  ->orderable(false),
    ...
    {
        return 'CargasCombustible_' . date('YmdHis');
    }
}
