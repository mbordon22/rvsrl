...
class CentroCostoDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ->editColumn('estado', function ($row) {
                return view('admin.inc.action', [
                    'toggle' => $row,
                    'name' => 'estado',
                    'route' => 'admin.gestion-contable.centro-costo.status',
                    'value' => $row->estado,
     ...
     */
    public function query(CentroCosto $model): QueryBuilder
    {
    ...
    {
        return 'CentroCosto_' . date('YmdHis');
    }
}
