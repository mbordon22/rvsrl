        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('estado', function ($row) {
                return view('admin.inc.action', [
                    'toggle' => $row,
                    'name' => 'estado',
                    'route' => 'admin.gestion-contable.ingresos.clientes.status',
                    'value' => $row->estado,
                    'permission' => auth()->user()->can('ingresos.edit')
                ]);
            })
            ->editColumn('action', function ($row) {
                ...
                if(auth()->user()->can('ingresos.edit')){
                    $acciones['edit'] = 'admin.gestion-contable.ingresos.clientes.edit';
                }
                if(auth()->user()->can('ingresos.trash')){
                    $acciones['delete'] = 'admin.gestion-contable.ingresos.clientes.destroy';
                }
