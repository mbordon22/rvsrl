...
namespace App\DataTables\GestionContable\Ingresos;
...
class ComprobantesIngresosDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('action', function ($row) {
                ...
                if(auth()->user()->can('ingresos.edit')){
                    $acciones['edit'] = 'admin.gestion-contable.ingresos.comprobantes.edit';
                }
                if(auth()->user()->can('ingresos.trash')){
                    $acciones['delete'] = 'admin.gestion-contable.ingresos.comprobantes.destroy';
                }
     ...
     */
    public function query(ComprobanteIngreso $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('comprobantes-ingresos-table')
    ...
    {
        return 'ComprobantesIngresos_' . date('YmdHis');
    }
}
