...
class UserDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('action', function ($row) {
                ...
                if (auth()->user()->can('user.edit')) {
                    $acciones['edit'] = 'admin.user.edit';
                }
                if (auth()->user()->can('user.destroy')) {
                    $acciones['delete'] = 'admin.user.destroy';
                }
            ...
            ->editColumn('status', function ($row) {
                return view('admin.inc.action', [
                    ...
                    'value' => $row->status,
                    'permission' => auth()->user()->can('user.edit')
                ]);
            })
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                ...
                ->addColumn(['data' => 'Image', 'title' => __('Imagen'), 'orderable' => false, 'searchable' => false,])
                ->addColumn(['data' => 'first_name', 'title' => __('Nombre'), 'orderable' => true, 'searchable' => true,])
                ->addColumn(['data' => 'email', 'title' => __('Email'), 'orderable' => false, 'searchable' => true,])
                ->addColumn(['data' => 'role', 'title' => __('Rol'), 'orderable' => false, 'searchable' => false,])
