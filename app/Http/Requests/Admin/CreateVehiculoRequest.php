...
class CreateVehiculoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'patente' => ['required', 'string', 'max:255', 'unique:vehiculos,patente,NULL,id,deleted_at,NULL'],
            ...
            'identificador_vehiculo' => ['required', 'string', 'max:255', 'unique:vehiculos,identificador_vehiculo,NULL,id,deleted_at,NULL'],
        ];
    }
}
