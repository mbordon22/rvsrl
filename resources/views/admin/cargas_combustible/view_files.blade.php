<div class="modal fade" id="viewFilesCombustibleModal" tabindex="-1" aria-labelledby="viewFilesCombustibleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewFilesCombustibleModalLabel"></h5>
