        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Comprobantes Egresos</li>
                ...
                <div class="card-body">
                    <div class="form theme-form">
                        <form class="row g-3 custom-input" id="ComprobantesForm"
                            action="{{ route('admin.gestion-contable.egresos.comprobantes.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
