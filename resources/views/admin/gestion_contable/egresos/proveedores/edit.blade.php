        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.gestion-contable.egresos.proveedores.index')}}">Proveedores</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3 custom-input" id="ProveedoresForm"
                        action="{{ route('admin.gestion-contable.egresos.proveedores.update', $proveedor->id) }}" method="POST"
