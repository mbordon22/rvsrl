        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.gestion-contable.ingresos.clientes.index')}}">Clientes</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3 custom-input" id="ClientesForm"
                        action="{{ route('admin.gestion-contable.ingresos.clientes.update', $cliente->id) }}" method="POST"
