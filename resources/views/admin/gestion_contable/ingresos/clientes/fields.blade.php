        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="codigo"
                    value="{{ isset($cliente->codigo) ? $cliente->codigo : old('codigo') }}"
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                @php
                    ...
                    $selectedTipo = old('tipo_documento', $cliente->tipo_documento ?? null);
                @endphp
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="numero_documento"
                    value="{{ isset($cliente->numero_documento) ? $cliente->numero_documento : old('numero_documento') }}" 
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="localidad"
                    value="{{ isset($cliente->localidad) ? $cliente->localidad : old('localidad') }}" 
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="codigo_postal"
                    value="{{ isset($cliente->codigo_postal) ? $cliente->codigo_postal : old('codigo_postal') }}" 
