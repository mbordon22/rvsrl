<div class="form theme-form">
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="mb-3">
                <label>Ingreso Desde<span> *</span></label>
    ...
    <div class="row">    
        ...
        <div class="col-sm-4">
            <div class="mb-3">
                <label>Cantidad actual en Almacen de destino</label>
    ...
    <div class="row">    
        <div class="col-sm-4">
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control" id="cantidad_ingreso" name="cantidad_ingreso"
                    placeholder="Cantidad a ingresar">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="mb-3">
                <label>Punto de alerta</label>
                <input type="number" min="0" class="form-control" id="punto_alerta" name="punto_alerta"
    ...
    @if (isset($stock))
        <input type="hidden" id="materiales_ingreso" name="materiales_ingreso"
        value="{{ $stock->materiales_ingreso }}">
    @else
        <input type="hidden" id="materiales_ingreso" name="materiales_ingreso" value="[]">
    @endif
    <div class="row mt-3">
        <div class="col-12">
            <h5>Materiales Ingreso</h5>
            <table class="table table-bordered" id="table-materiales">
                ...
                <tbody>
                    ...
                    <tr id="row_{{ $key }}">
                        ...
                        <td>{{ $fila->elemento->punto_alerta }}</td>
                        <td>
