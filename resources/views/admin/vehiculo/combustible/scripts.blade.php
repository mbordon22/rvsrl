...
$(document).on('click', '#add-combustible-btn', function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            $('#vehiculocombustible-table').DataTable().ajax.reload(null, false);
...
$(document).on('click', '.edit-document-btn', function () {
    ...
    $.get(url, function (data) {
        ...
        $('#edit-combustible-form').attr('action', `{{ url('admin/vehiculos/combustible') }}/${id}`);
...
$(document).on('click', '.btn-delete', function() {
    ...
    swal({
        ...
        if (willDelete) {
            $.ajax({
                url: `/admin/vehiculos/combustible/${id}`,
                type: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
