                        ...
                        <div class="card-body bg-primary">
                            <div class="blog-tags">
                                ...
                                <div class="tag-details">
                                    <h2 class="total-num counter">{{ sprintf("%02d",App\Models\Vehiculo::all()->count()) }}</h2>
                                    <p>Total Vehículos</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card user-management">
                        <div class="card-body bg-primary">
                            <div class="blog-tags">
                                ...
                                <div class="tag-details">
                                    <h2 class="total-num counter">{{ $cargas_combustible_mes_actual }}</h2>
                                    <p>Total cargas combustibles en el mes corriente</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card user-role">
                        <div class="card-body border-b-primary border-2">
                            <div class="upcoming-box">
                                ...
                                <p>Vehiculo</p>
                                <a href="{{ route('admin.vehiculo.create') }}" class="btn btn-primary">Nuevo Vehiculo</a>
                            </div>
                        </div>
                    </div>
                </div>
