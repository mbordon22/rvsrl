...
$(document).on('click', '#add-tipo-vehiculo-btn', function (e) {
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function (response) {
            $('#tipovehiculo-table').DataTable().ajax.reload(null, false);
            ...
            swal({
                ...
                $('#addTipoVehiculoModal').modal('hide');
            });
        },
        error: function (xhr) {
...
$(document).on('click', '.btn-delete', function() {
    ...
    swal({
        ...
        if (willDelete) {
            $.ajax({
                url: `/admin/vehiculos/tipos-vehiculo/${id}`,
                type: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
