    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>How to use it?</h4><span class="font-dark">All you have to do is to add <code>data-aos</code>
                            attribute to html element, like so:</span>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4> Advanced settings</h4><span class="font-dark">These settings can be set both on certain
                            elements, or as default while initializing script (in options object without <code> data- part).
                            </code></span>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4> Animation </h4><span class="font-dark">There are serveral predefined animations you can use
                            already:</span>
                    </div>
                    <div class="card-body">
                        <ul class="line">
