            ...
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="row gallery grid my-gallery" id="aniimated-thumbnials" itemscope="">
                            <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia"
                                data-wow-delay="0.5s" itemscope=""><a
                            ...
                            <figure class="grid-item col-md-3 col-6 wow rollIn center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/4.jpg') }}"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/6.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInLeft" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/7.jpg') }}"
                                    itemprop="contentUrl" data-size="11600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow flipInX center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/8.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/9.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow rollIn center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/10.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow rollIn" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/14.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight" itemprop="associatedMedia"
                                data-wow-delay="1.5s" itemscope=""><a
                            ...
                            <figure class="grid-item col-md-3 col-6 wow bounceInRight center" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/15.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/masonry/15.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                            ...
                            <figure class="grid-item col-md-3 col-6 wow lightSpeedIn" itemprop="associatedMedia"
                                itemscope=""><a href="{{ asset('assets/images/big-masonry/5.jpg') }}"
                                    itemprop="contentUrl" data-size="1600x950"><img class="img-thumbnail"
                                        src="{{ asset('assets/images/masonry/5.jpg') }}" itemprop="thumbnail"
                                        alt="Image description"></a>
                ...
                <div class="card">
                    <div class="card-header wow-title">
                        <h5><span class="badge badge-primary rounded-pill me-2">1</span>Setup wow.js</h5><span
                            class="font-dark">(You can link to another CSS animation library by changing wow.js
                            settings)</span>
                    </div>
                    <div class="card-body">
                        <div>
                ...
                <div class="card">
                    <div class="card-header wow-title">
                        <h5><span class="badge badge-primary rounded-pill me-2">3</span>Make an element revealable</h5>
                        <span class="font-dark">(You can change this CSS class in the WOW settings to avoid name
                            conflicts.)</span>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header wow-title">
                        <h5><span class="badge badge-primary rounded-pill me-2">4</span>Choose the animation style</h5>
                        <span class="font-dark">Pick an animation style in Animate.css , then add the CSS class to the HTML
                            element</span>
                    </div>
                    <div class="card-body">
                        <div>
