                        ...
                        <div>
                            ...
                            <div class="login-main">
                                ...
                                <form class="theme-form" method="POST" action="{{ route('password.email') }}">
                                    @csrf
                                    <h4 class="mb-3">Restablecer su Contraseña</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="text-end mt-2">
                                                    <button class="btn btn-primary" type="submit" style="inline-size: -webkit-fill-available;">Enviar Enlace para Restablecer Contraseña</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="{{ route('login') }}" class="text-center">
                                    <p>Volver a la Página de Inicio de Sesión</p>
                                </a>
                            </div>
                        </div>
                    </div>
