                ...
                <div class="col-sm-12">
                            ...
                            <div class="row g-2">
                                <div class="col-xl-9 col-md-12 docs-buttons">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn alert-light-primary" type="button" data-method="setDragMode"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button class="btn alert-light-primary" type="button" data-method="zoom"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-outline-secondary" type="button" data-method="move"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-outline-success" type="button" data-method="rotate"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-outline-info" type="button" data-method="scaleX"
                                        ...
                                        <button class="btn btn-outline-info" type="button" data-method="scaleY"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-outline-warning" type="button" data-method="crop"
                                        ...
                                        <button class="btn btn-outline-warning" type="button" data-method="clear"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-outline-danger" type="button" data-method="disable"
                                        ...
                                        <button class="btn btn-outline-danger" type="button" data-method="enable"
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-outline-dark" type="button" data-method="reset"
                                        ...
                                        <label class="btn btn-outline-dark btn-upload" for="inputImage"
                                        ...
                                        <button class="btn btn-outline-dark" type="button" data-method="destroy"
                                    ...
                                    <!-- /.modal-->
                                    <button class="btn btn-outline-danger" type="button" data-method="moveTo"
                                    ...
                                    <button class="btn btn-outline-info" type="button" data-method="zoomTo"
                                    ...
                                    <button class="btn btn-outline-success" type="button" data-method="rotateTo"
                                        data-option="180"><span class="docs-tooltip" data-bs-toggle="tooltip"
                                            ...
                                            180°</span></button>
                                    <button class="btn btn-outline-warning" type="button" data-method="scale"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Minimum Zone Size</h4>
                                    <p class="f-m-light mt-1">
                                        Use the<code>.crop-min </code>class through minimum and maximum crop size defined.
                                    </p>
                                </div>
                                <div class="card-body">
