                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Movie rating is displayed using <code>#u-rating-movie</code> id using javascript.</p>
                    </div>
                    <div class="card-body">
                        <div class="rating-container">
            ...
            <div class="col-xxl-4 col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Star rating is displayed using <code>#u-rating-fontawesome </code> id using javascript.</p>
                    </div>
                    <div class="card-body">
                        <div class="rating-container">
