                    ...
                    <div class="card-body">
                        <ul class="square-timeline">
                            ...
                            <li class="timeline-event">
                                <label class="timeline-event-icon"></label>
                                <div class="timeline-event-wrapper">
                                    <p class="timeline-thumbnail">December 2022 - Meetup</p>
                    ...
                    <div class="card-body dark-timeline">
                        <ul>
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    <p class="d-flex justify-content-between mb-2"><span
                                            class="date-content light-background txt-dark">8th March, 2022 </span><span>1
                                            day ago</span></p>
                            ...
                            <li class="d-flex pb-0">
                                ...
                                <div class="w-100 ms-3">
                                    <p class="d-flex justify-content-between mb-2"><span
                                            class="date-content light-background txt-dark">20th Sep, 2022
