                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Use the <code>.hide </code>class through hide toast and <code>.show </code>class through
                    ...
                    <div class="card-body position-relative common-flex">
                        ...
                        <div class="toast-container position-fixed top-0 end-0 p-3 toast-index toast-rtl">
                            <div class="toast hide toast fade" id="liveToast" role="alert" aria-live="assertive"
                                ...
                                <div class="toast-header toast-img"><img class="rounded me-2"
                                        src="{{ asset('assets/images/dashboard-3/profile.png') }}" alt="profile"><strong
                                        class="me-auto">Riho Theme</strong><small>5 min ago</small>
                        ...
                        <button class="btn btn-secondary" id="liveToastBtn1" type="button">Bottom-right
                            toast</button>
                        ...
                        <div class="toast-container position-fixed start-0 top-0 p-3 toast-index toast-rtl">
                            <div class="toast hide toast fade" id="liveToast2" role="alert" aria-live="assertive"
                                ...
                                <div class="toast-header toast-img"><img class="rounded me-2"
                                        src="{{ asset('assets/images/dashboard-3/profile.png') }}" alt="profile"><strong
                                        class="me-auto">Riho Theme</strong><small class="d-sm-block d-none">10 min
                                        ago</small>
                                    <button class="btn-close" type="button" data-bs-dismiss="toast"
                                        aria-label="Close"></button>
                                </div>
                                <div class="toast-body toast-dark"><strong class="txt-success">Well done!</strong>
                        ...
                        <div class="toast-container position-fixed start-0 bottom-0 p-3 toast-index toast-rtl">
                            <div class="toast hide toast fade" id="liveToast3" role="alert" aria-live="assertive"
                                ...
                                <div class="toast-header toast-img"><img class="rounded me-2"
                                        src="{{ asset('assets/images/dashboard-3/profile.png') }}" alt="profile"><strong
                                        class="me-auto">Riho Theme</strong>
                                    <button class="btn-close" type="button" data-bs-dismiss="toast"
                                        aria-label="Close"></button>
                                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            ...
                            some spacing.<code>[toast-*]</code>through change icons colors.</p>
                    </div>
                    <div class="card-body toast-rtl">
                        <div class="toast-container position-static">
                            <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                                <div class="toast-header"><i class="toast-icons toast-primary"
                                        data-feather="bell"></i><strong class="me-auto">Riho theme</strong><small
            ...
            <div class="col-md-6">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Use the <code>.hide </code>class through hide toast and <code>.show </code>class through
                            visible toast and given directions.<code>[toast-*]</code>through change icons colors.
                        </p>
                    </div>
                        ...
                        <div class="toast-container">
                            <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                                <div class="toast-header"><i class="toast-icons toast-info"
                                        data-feather="disc"></i><strong class="me-auto">Riho theme</strong><small
                            ...
                            <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                                <div class="toast-header"><i class="toast-icons toast-secondary"
                                        data-feather="disc"></i><strong class="me-auto">Fastkart
                                        theme</strong><small class="txt-danger d-sm-block d-none">just now</small>
                                    <button class="btn-close" type="button" data-bs-dismiss="toast"
                                        aria-label="Close"></button>
                                </div>
                                <div class="toast-body toast-dark"> Hello, I'm a UX-designer.</div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Use the <code>.hide </code>class through hide toast and <code>.show </code>class through
                            visible toast.<code>.form-select</code> through select any positions.</p>
                    </div>
                            ...
                            <div class="toast-container p-3 position-absolute" id="toastPlacement">
                                <div class="toast toast-fade show">
                                    <div class="toast-header toast-img"><img class="rounded me-2"
                                            ...
                                            alt="profile"><strong class="me-auto">Riho Theme</strong><small
                                            class="d-sm-block d-none">25
                                            min ago</small></div>
                                    <div class="toast-body toast-dark txt-dark">
                                        <p class="toast-content"><em class="txt-danger">Attackers</em> on
                                            malicious activity may trick you into doing something dangrous like
                                            installing software or revealing your personal informations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
