            ...
            <div class="md-sidebar-aside job-left-aside custom-scrollbar">
                ...
                <div class="card">
                    ...
                    <div class="email-app-sidebar left-bookmark">
                        ...
                        <li class="nav-item">
                            <button class="btn-primary btn-block btn-mail w-100" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="me-2" data-feather="bookmark"></i> New Bookmark  </button>
                        </li>
                        <li class="nav-item"> <span class="main-title f-w-500"> Views </span></li>
                        <li> <a class="active" id="pills-created-tab" data-bs-toggle="pill" href="#pills-created" role="tab" aria-controls="pills-created" aria-selected="true"><span class="title f-w-400"> Created by me</span></a></li>
                        <li><a id="pills-favourites-tab" data-bs-toggle="pill" href="#pills-favourites" role="tab" aria-controls="pills-favourites" aria-selected="false"><span class="title f-w-400"> Favourites</span></a></li>
                        <li><a id="pills-shared-tab" data-bs-toggle="pill" href="#pills-shared" role="tab" aria-controls="pills-shared" aria-selected="false"><span class="title f-w-400"> Shared with me</span></a></li>
                        <li><a id="pills-bookmark-tab" data-bs-toggle="pill" href="#pills-bookmark" role="tab" aria-controls="pills-bookmark" aria-selected="false"><span class="title f-w-400"> My bookmark</span></a></li>
                        <li>
                            <hr>
                        </li>
                        <li><span class="main-title f-w-500"> Tags<span class="pull-right"><a href="#" data-bs-toggle="modal" data-bs-target="#createtag"><i data-feather="plus-circle"></i></a></span></span></li>
                        <li><a id="pills-notification-tab" data-bs-toggle="pill" href="#pills-notification" role="tab" aria-controls="pills-notification" aria-selected="false"><span class="title f-w-400"> notification</span></a></li>
                        <li><a id="pills-newsletter-tab" data-bs-toggle="pill" href="#pills-newsletter" role="tab" aria-controls="pills-newsletter" aria-selected="false"><span class="title f-w-400"> Newsletter</span></a></li>
                        <li><a id="pills-business-tab" data-bs-toggle="pill" href="#pills-business" role="tab" aria-controls="pills-business-tab" aria-selected="false"><span class="title f-w-400"> Business</span></a></li>
                        <li><a id="pills-holidays-tab" data-bs-toggle="pill" href="#pills-holidays" role="tab" aria-controls="pills-holidays-tab" aria-selected="false"><span class="title f-w-400"> Holidays</span></a></li>
                        <li><a id="pills-important-tab" data-bs-toggle="pill" href="#pills-important" role="tab" aria-controls="pills-important-tab" aria-selected="false"><span class="title f-w-400"> Important</span></a></li>
                        <li><a id="pills-orgenization-tab" data-bs-toggle="pill" href="#pills-orgenization" role="tab" aria-controls="pills-orgenization-tab" aria-selected="false"><span class="title f-w-400"> Organization</span></a></li>
                        </ul>
                    </div>
                    </div>
                </div>
            ...
            <div class="card email-body radius-left">
                ...
                <div class="tab-content">
                    ...
                    <div class="card mb-0">
                        ...
                        <h4 class="mb-0 f-w-600">Created by me</h4>
                        <ul>
                        ...
                        <div class="details-bookmark text-center">
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/01.jpg') }}" alt="">
                                    ...
                                    <div class="title-bookmark">
                                        <h6 class="title_0 f-w-500">Admin Template</h6>
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/02.jpg') }}" alt="">
                                    ...
                                    <div class="desciption-data">
                                    <div class="title-bookmark">
                                        <h6 class="title_1 f-w-500">Universal Template</h6>
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/03.jpg') }}" alt="">
                                    ...
                                    <div class="desciption-data">
                                    <div class="title-bookmark">
                                        <h6 class="title_2 f-w-500">Angular Theme</h6>
                                        <p class="weburl_2">https://angular.pixelstrap.com/Riho/landing</p>
                                        <div class="hover-block">
                                        <ul>
                                        ...
                                        <div class="content-general">
                                        <p class="desc_2">Riho is beautifully crafted, clean and modern designed admin theme</p><span class="collection_2">Fs</span>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/04.jpg') }}" alt="">
                                    ...
                                    <div class="desciption-data">
                                    <div class="title-bookmark">
                                        <h6 class="title_3 f-w-500">Multikart Admin</h6>
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/05.jpg') }}" alt="">
                                    ...
                                    <div class="desciption-data">
                                    <div class="title-bookmark">
                                        <h6 class="title_4 f-w-500">Ecommerece theme</h6>
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/06.jpg') }}" alt="">
                                    ...
                                    <div class="desciption-data">
                                    <div class="title-bookmark">
                                        <h6 class="title_5 f-w-500">Tovo app landing page</h6>
                    ...
                    <div class="card mb-0">
                        <div class="card-header d-flex">
                        <h4 class="mb-0">Shared with me</h6>
                        <ul>
                            <li><a class="grid-bookmark-view" href="#"><i data-feather="grid"></i></a></li>
                            <li><a class="list-layout-view" href="#"><i data-feather="list"></i></a></li>
                        </ul>
                        ...
                        <div class="details-bookmark text-center">
                            ...
                            <div class="col-xxl-3 col-md-4 col-ed-4">
                                ...
                                <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallry/07.jpg') }}" alt="">
                                    ...
                                    <div class="title-bookmark">
                                        <h6 class="title_0 f-w-500">Admin Template</h6>
                                        <p class="weburl_0">http://admin.pixelstrap.com/Riho/ltr/landing-page.html</p>
                                        <div class="hover-block">
                                        <ul>
                                            <li><a href="" onclick="editBookmark(0)" data-bs-toggle="modal" data-bs-target="#edit-bookmark"><i data-feather="edit-2"></i></a></li>
                                            <li><a href="#"><i data-feather="link"></i></a></li>
                                        ...
                                        <div class="content-general">
                                        <p class="desc_0">Riho is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</p><span class="collection_0">General</span>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content"> 
                        <div class="modal-header"> 
                            <h4 class="modal-title" id="exampleModalLabel">Add Bookmark</h5>
                            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
