    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body btn-group-showcase">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xxl-4 button-group-mb-sm">
                                <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>large Edges Button group</h4>
                    </div>
                    <div class="card-body btn-group-showcase">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xxl-4">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Outline Custom button group</h4>
                    </div>
                    <div class="card-body btn-group-showcase">
                        <div class="row">
                            <div class="col-xxl-4 col-md-6 col-sm-12">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Radio button group</h4><span>Add <code>.active</code> for active state and<code>.disabled</code>
                            class or <code>disabled="disabled"</code> attribute</span>
                    </div>
                    <div class="card-body btn-group-showcase">
                        <div class="row">
                            <div class="col-xxl-4 col-md-6 col-sm-12">
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-primary active">
                                            <div class="radio radio-primary">
                                                <input id="radio8" type="radio" name="radio1" value="option1"
                                                    checked="">
                                ...
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-secondary active">
                                            <div class="radio radio-secondary">
                                                <input id="radio12" type="radio" name="radio2" value="option1"
                                                    checked="">
                                ...
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-success active">
                                            <div class="radio radio-success">
                                                <input id="radio14" type="radio" name="radio3" value="option1"
                                                    checked="">
                                ...
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-info active">
                                            <div class="radio radio-info">
                                                <input id="radio16" type="radio" name="radio4" value="option1"
                                                    checked="">
                                ...
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-warning active">
                                            <div class="radio radio-warning">
                                                <input id="radio18" type="radio" name="radio5" value="option1"
                                                    checked="">
                                ...
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-danger active">
                                            <div class="radio radio-danger">
                                                <input id="radio22" type="radio" name="radio6" value="option1"
                                                    checked="">
                                ...
                                <div class="btn-radio">
                                    <div class="btn-group" data-bs-toggle="buttons">
                                        ...
                                        <div class="btn btn-light active txt-dark">
                                            <div class="radio radio-light">
                                                <input id="radio24" type="radio" name="radio7" value="option1"
                                                    checked="">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Check Box button group</h4><span>Add <code>.active</code> for active state and
                            <code>.disabled</code> class or <code>disabled="disabled"</code> attribute</span>
                    </div>
                    <div class="card-body btn-group-showcase">
                        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card height-equal">
                    <div class="card-header">
                        <h4>Nesting</h4><span>Make nesting buttons</span>
                    </div>
                        ...
                        <div class="m-b-30">
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <div class="btn-group" role="group">
                                    <button class="btn btn-light dropdown-toggle" id="btnGroupDrop1" type="button"
                                        data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">Dropdown</button>
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1"><a
                                            class="dropdown-item" href="#">Dropdown link</a><a
                                            class="dropdown-item" href="#">Dropdown link</a><a
                                            class="dropdown-item" href="#">Dropdown link</a><a
                                            class="dropdown-item" href="#">Dropdown link</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="m-b-30">
            ...
            <div class="col-lg-6">
                <div class="card height-equal">
                    <div class="card-header">
                        <h4>Vertical</h4><span>Make vertical buttons</span>
                    </div>
                    <div class="card-body btn-group-wrapper">
                        <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                            ...
                            <div class="btn-group" role="group">
                                <button class="btn btn-success dropdown-toggle" id="btnGroupVerticalDrop1"
                                    type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">Dropdown</button>
                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1"><a
                                        class="dropdown-item" href="#">Dropdown link</a><a class="dropdown-item"
                                        href="#">Dropdown link</a></div>
                            </div>
                            <button class="btn btn-info" type="button">Button</button>
                            <button class="btn btn-warning" type="button">Button</button>
                            <div class="btn-group" role="group">
                                <button class="btn btn-danger dropdown-toggle" id="btnGroupVerticalDrop2"
                                    type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">Dropdown</button>
                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2"><a
                                        class="dropdown-item" href="#">Dropdown link</a><a class="dropdown-item"
                                        href="#">Dropdown link</a></div>
                            </div>
                            <div class="btn-group" role="group">
                                <button class="btn btn-light dropdown-toggle" id="btnGroupVerticalDrop3"
                                    type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">Dropdown</button>
                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop3"><a
                                        class="dropdown-item" href="#">Dropdown link</a><a class="dropdown-item"
                                        href="#">Dropdown link</a></div>
                            </div>
                        </div>
