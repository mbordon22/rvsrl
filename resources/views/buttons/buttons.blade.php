...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="large-btn">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-primary btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-primary btn-lg">Primary Button</button>
                        <button class="btn btn-secondary btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-secondary btn-lg">Secondary Button</button>
                        <button class="btn btn-success btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-success btn-lg">Success Button</button>
                        <button class="btn btn-info btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-info btn-lg">Info Button</button>
                        <button class="btn btn-warning btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-warning btn-lg">Warning Button</button>
                        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-danger btn-lg">Danger Button</button>
                        <button class="btn btn-light btn-lg" type="button" data-bs-toggle="tooltip"
                            title="btn btn-light btn-lg">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="small-btn">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-primary btn-sm" type="button" title="btn btn-primary btn-sm">Primary
                            Button</button>
                        <button class="btn btn-secondary btn-sm" type="button"
                            title="btn btn-secondary btn-sm">Secondary Button</button>
                        <button class="btn btn-success btn-sm" type="button" title="btn btn-success btn-sm">Success
                            Button</button>
                        <button class="btn btn-info btn-sm" type="button" title="btn btn-info btn-sm">Info
                            Button</button>
                        <button class="btn btn-warning btn-sm" type="button" title="btn btn-warning btn-sm">Warning
                            Button</button>
                        <button class="btn btn-danger btn-sm" type="button" title="btn btn-danger btn-sm">Danger
                            Button</button>
                        <button class="btn btn-light btn-sm" type="button" title="btn btn-light btn-sm">Light
                            Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="ex-small-btn">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-primary btn-xs" type="button" title="btn btn-primary btn-xs">Primary
                            Button</button>
                        <button class="btn btn-secondary btn-xs" type="button"
                            title="btn btn-secondary btn-xs">Secondary Button</button>
                        <button class="btn btn-success btn-xs" type="button" title="btn btn-success btn-xs">Success
                            Button</button>
                        <button class="btn btn-info btn-xs" type="button" title="btn btn-info btn-xs">Info
                            Button</button>
                        <button class="btn btn-warning btn-xs" type="button" title="btn btn-warning btn-xs">Warning
                            Button</button>
                        <button class="btn btn-danger btn-xs" type="button" title="btn btn-danger btn-xs">Danger
                            Button</button>
                        <button class="btn btn-light btn-xs" type="button" title="btn btn-light btn-xs">Light
                            Button</button>
                        <div class="code-box-copy">
                ...
                <div class="card" id="active-btn">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-primary active" type="button"
                            title="btn btn-primary active">Active</button>
                        <button class="btn btn-secondary active" type="button"
                            title="btn btn-secondary active">Active</button>
                        <button class="btn btn-success active" type="button"
                            title="btn btn-success active">Active</button>
                        <button class="btn btn-info active" type="button" title="btn btn-info active">Active</button>
                        <button class="btn btn-warning active txt-dark" type="button"
                            title="btn btn-warning active">Active</button>
                        <button class="btn btn-danger active" type="button"
                            title="btn btn-danger active">Active</button>
                        <button class="btn btn-light active txt-dark" type="button"
                            title="btn btn-light active">Active</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="custom-state-button">
                    ...
                    <div class="card-body common-flex"><a class="btn btn-primary" href="#" data-toggle="tooltip"
                            title="btn btn-primary" role="button">Link</a>
                        <input class="btn btn-secondary" type="button" value="Input" data-toggle="tooltip"
                            title="btn btn-secondary">
                        <input class="btn btn-success" type="submit" value="Submit" data-toggle="tooltip"
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="outline-button">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-outline-primary" type="button" title="btn btn-outline-primary">Primary
                            Button</button>
                        <button class="btn btn-outline-secondary" type="button"
                            title="btn btn-outline-secondary">Secondary Button</button>
                        <button class="btn btn-outline-success" type="button" title="btn btn-outline-success">Success
                            Button</button>
                        <button class="btn btn-outline-info" type="button" title="btn btn-outline-info">Info
                            Button</button>
                        <button class="btn btn-outline-warning" type="button" title="btn btn-outline-warning">Warning
                            Button</button>
                        <button class="btn btn-outline-danger" type="button" title="btn btn-outline-danger">Danger
                            Button</button>
                        <button class="btn btn-outline-light txt-dark" type="button" title="btn btn-outline-light">Light
                            Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="outline-bold-button">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-outline-primary-2x" type="button"
                            title="btn btn-outline-primary-2x">Primary Button</button>
                        <button class="btn btn-outline-secondary-2x" type="button"
                            title="btn btn-outline-secondary-2x">Secondary Button</button>
                        <button class="btn btn-outline-success-2x" type="button"
                            title="btn btn-outline-success-2x">Success Button</button>
                        <button class="btn btn-outline-info-2x" type="button" title="btn btn-outline-info-2x">Info
                            Button</button>
                        <button class="btn btn-outline-warning-2x" type="button"
                            title="btn btn-outline-warning-2x">Warning Button</button>
                        <button class="btn btn-outline-danger-2x" type="button" title="btn btn-outline-danger-2x">Danger
                            Button</button>
                        <button class="btn btn-outline-light-2x txt-dark" type="button"
                            title="btn btn-outline-light-2x">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="outline-large-button">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-outline-*</code> class for outline and <code>.btn-lg</code> class for
                            large button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-outline-primary btn-lg" type="button"
                            title="btn btn-outline-primary btn-lg">Primary Button</button>
                        ...
                        <button class="btn btn-outline-success btn-lg" type="button"
                            title="btn btn-outline-success btn-lg">Success Button</button>
                        <button class="btn btn-outline-info btn-lg" type="button"
                            title="btn btn-outline-info btn-lg">Info Button</button>
                        <button class="btn btn-outline-warning btn-lg" type="button"
                            title="btn btn-outline-warning btn-lg">Warning Button</button>
                        <button class="btn btn-outline-danger btn-lg" type="button"
                            title="btn btn-outline-danger btn-lg">Danger Button</button>
                        <button class="btn btn-outline-light txt-dark btn-lg" type="button"
                            title="btn btn-outline-light btn-lg">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="outline-small-button">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-outline-*</code> class for outline and <code>.btn-sm</code> class for
                            small button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-outline-primary btn-sm" type="button"
                            title="btn btn-outline-primary btn-sm">Primary Button</button>
                        <button class="btn btn-outline-secondary btn-sm" type="button"
                            title="btn btn-outline-secondary btn-sm">Secondary Button</button>
                        <button class="btn btn-outline-success btn-sm" type="button"
                            title="btn btn-outline-success btn-sm">Success Button</button>
                        <button class="btn btn-outline-info btn-sm" type="button"
                            title="btn btn-outline-info btn-sm">Info Button</button>
                        <button class="btn btn-outline-warning btn-sm" type="button"
                            title="btn btn-outline-warning btn-sm">Warning Button</button>
                        <button class="btn btn-outline-danger btn-sm" type="button"
                            title="btn btn-outline-danger btn-sm">Danger Button</button>
                        <button class="btn btn-outline-light btn-sm txt-dark" type="button"
                            title="btn btn-outline-light btn-sm">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="ex-outline-small-button">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-outline-*</code> class for outline and <code>.btn-xs</code> class for
                            extra small button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-outline-primary btn-xs" type="button"
                            title="btn btn-outline-primary btn-xs">Primary Button</button>
                        ...
                        <button class="btn btn-outline-success btn-xs" type="button"
                            title="btn btn-outline-success btn-xs">Success Button</button>
                        <button class="btn btn-outline-info btn-xs" type="button"
                            title="btn btn-outline-info btn-xs">Info Button</button>
                        <button class="btn btn-outline-warning btn-xs" type="button"
                            title="btn btn-outline-warning btn-xs">Warning Button</button>
                        <button class="btn btn-outline-danger btn-xs" type="button"
                            title="btn btn-outline-danger btn-xs">Danger Button</button>
                        <button class="btn btn-outline-light btn-xs txt-dark" type="button"
                            title="btn btn-outline-light btn-xs">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="gradiant">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-primary-gradien" type="button" title="btn btn-primary-gradien">Primary
                            Button</button>
                        <button class="btn btn-secondary-gradien" type="button"
                            title="btn btn-secondary-gradien">Secondary Button</button>
                        <button class="btn btn-success-gradien" type="button" title="btn btn-success-gradien">Success
                            Button</button>
                        <button class="btn btn-info-gradien" type="button" title="btn btn-info-gradien">Info
                            Button</button>
                        <button class="btn btn-warning-gradien" type="button" title="btn btn-warning-gradien">Warning
                            Button</button>
                        <button class="btn btn-danger-gradien" type="button" title="btn btn-danger-gradien">Danger
                            Button</button>
                        <div class="code-box-copy">
