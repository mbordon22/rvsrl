            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edge Buttons</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code> class for edge button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-primary" type="button" title="btn btn-pill btn-primary">Primary
                            Button</button>
                        <button class="btn btn-pill btn-secondary" type="button"
                            title="btn btn-pill btn-secondary">Secondary Button</button>
                        <button class="btn btn-pill btn-success" type="button" title="btn btn-pill btn-success">Success
                            Button</button>
                        <button class="btn btn-pill btn-info" type="button" title="btn btn-pill btn-info">Info
                            Button</button>
                        <button class="btn btn-pill btn-warning" type="button" title="btn btn-pill btn-warning">Warning
                            Button</button>
                        <button class="btn btn-pill btn-danger" type="button" title="btn btn-pill btn-danger">Danger
                            Button</button>
                        <button class="btn btn-pill btn-light" type="button" title="btn btn-pill btn-light">Light
                            Button</button>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code> and <code>.btn-lg</code> class for large button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-primary btn-lg" type="button"
                            title="btn btn-pill btn-primary btn-lg">Primary Button</button>
                        <button class="btn btn-pill btn-secondary btn-lg" type="button"
                            title="btn btn-pill btn-secondary btn-lg">Secondary Button</button>
                        <button class="btn btn-pill btn-success btn-lg" type="button"
                            title="btn btn-pill btn-success btn-lg">Success Button</button>
                        <button class="btn btn-pill btn-info btn-lg" type="button"
                            title="btn btn-pill btn-info btn-lg">Info Button</button>
                        <button class="btn btn-pill btn-warning btn-lg" type="button"
                            title="btn btn-pill btn-warning btn-lg">Warning Button</button>
                        <button class="btn btn-pill btn-danger btn-lg" type="button"
                            title="btn btn-pill btn-danger btn-lg">Danger Button</button>
                        <button class="btn btn-pill btn-light btn-lg" type="button"
                            title="btn btn-pill btn-light btn-lg">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code> and <code>.btn-sm</code> class for small button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-primary btn-sm" type="button"
                            title="btn btn-pill btn-primary btn-sm">Primary Button</button>
                        <button class="btn btn-pill btn-secondary btn-sm" type="button"
                            title="btn btn-pill btn-secondary btn-sm">Secondary Button</button>
                        <button class="btn btn-pill btn-success btn-sm" type="button"
                            title="btn btn-pill btn-success btn-sm">Success Button</button>
                        <button class="btn btn-pill btn-info btn-sm" type="button"
                            title="btn btn-pill btn-info btn-sm">Info Button</button>
                        <button class="btn btn-pill btn-warning btn-sm" type="button"
                            title="btn btn-pill btn-warning btn-sm">Warning Button</button>
                        <button class="btn btn-pill btn-danger btn-sm" type="button"
                            title="btn btn-pill btn-danger btn-sm">Danger Button</button>
                        <button class="btn btn-pill btn-light btn-sm" type="button"
                            title="btn btn-pill btn-light btn-sm">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    ...
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-primary active" type="button"
                            title="btn btn-pill btn-primary active">Active</button>
                        <button class="btn btn-pill btn-secondary active" type="button"
                            title="btn btn-pill btn-secondary active">Active</button>
                        <button class="btn btn-pill btn-success active" type="button"
                            title="btn btn-pill btn-success active">Active</button>
                        <button class="btn btn-pill btn-info active" type="button"
                            title="btn btn-pill btn-info active">Active</button>
                        <button class="btn btn-pill btn-warning active" type="button"
                            title="btn btn-pill btn-warning active">Active</button>
                        <button class="btn btn-pill btn-danger active" type="button"
                            title="btn btn-pill btn-danger active">Active</button>
                        <button class="btn btn-pill btn-light active txt-dark" type="button"
                            title="btn btn-pill btn-light active">Active</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    ...
                    <div class="card-body common-flex"><a class="btn btn-pill btn-primary" href="#"
                            data-toggle="tooltip" title="btn btn-primary" role="button">Link</a>
                        <input class="btn btn-pill btn-secondary" type="button" value="Input" data-toggle="tooltip"
                            title="btn btn-secondary">
                        <input class="btn btn-pill btn-success" type="submit" value="Submit" data-toggle="tooltip"
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code> and <code>.btn-outline-*</code> class for button with
                            outline</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-outline-primary" type="button"
                            title="btn btn-pill btn-outline-primary">Primary Button</button>
                        <button class="btn btn-pill btn-outline-secondary" type="button"
                            title="btn btn-pill btn-outline-secondary">Secondary Button</button>
                        <button class="btn btn-pill btn-outline-success" type="button"
                            title="btn btn-pill btn-outline-success">Success Button</button>
                        <button class="btn btn-pill btn-outline-info" type="button"
                            title="btn btn-pill btn-outline-info">Info Button</button>
                        <button class="btn btn-pill btn-outline-warning" type="button"
                            title="btn btn-pill btn-outline-warning">Warning Button</button>
                        <button class="btn btn-pill btn-outline-danger" type="button"
                            title="btn btn-pill btn-outline-danger">Danger Button</button>
                        <button class="btn btn-pill btn-outline-light txt-dark" type="button"
                            title="btn btn-pill btn-outline-light">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code> and <code>.btn-outline-*-2x</code> class for button with bold
                            outline</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-outline-primary-2x" type="button"
                            title="btn btn-pill btn-outline-primary-2x">Primary Button</button>
                        <button class="btn btn-pill btn-outline-secondary-2x" type="button"
                            title="btn btn-pill btn-outline-secondary-2x">Secondary Button</button>
                        <button class="btn btn-pill btn-outline-success-2x" type="button"
                            title="btn btn-pill btn-outline-success-2x">Success Button</button>
                        <button class="btn btn-pill btn-outline-info-2x" type="button"
                            title="btn btn-pill btn-outline-info-2x">Info Button</button>
                        <button class="btn btn-pill btn-outline-warning-2x" type="button"
                            title="btn btn-pill btn-outline-warning-2x">Warning Button</button>
                        <button class="btn btn-pill btn-outline-danger-2x" type="button"
                            title="btn btn-pill btn-outline-danger-2x">Danger Button</button>
                        <button class="btn btn-pill btn-outline-light-2x txt-dark" type="button"
                            title="btn btn-pill btn-outline-light-2x">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code>,<code>.btn-outline-*</code> and <code>.btn-lg</code> class
                            for large button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-outline-primary btn-lg" type="button"
                            title="btn btn-pill btn-outline-primary btn-lg">Primary Button</button>
                        <button class="btn btn-pill btn-outline-secondary btn-lg" type="button"
                            title="btn btn-pill btn-outline-secondary btn-lg">Secondary Button</button>
                        <button class="btn btn-pill btn-outline-success btn-lg" type="button"
                            title="btn btn-pill btn-outline-success btn-lg">Success Button</button>
                        <button class="btn btn-pill btn-outline-info btn-lg" type="button"
                            title="btn btn-pill btn-outline-info btn-lg">Info Button</button>
                        <button class="btn btn-pill btn-outline-warning btn-lg" type="button"
                            title="btn btn-pill btn-outline-warning btn-lg">Warning Button</button>
                        <button class="btn btn-pill btn-outline-danger btn-lg" type="button"
                            title="btn btn-pill btn-outline-danger btn-lg">Danger Button</button>
                        <button class="btn btn-pill btn-outline-light btn-lg txt-dark" type="button"
                            title="btn btn-pill btn-outline-light btn-lg">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code>,<code>.btn-outline-*</code> and <code>.btn-sm</code> class
                            for small button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-outline-primary btn-sm" type="button"
                            title="btn btn-pill btn-outline-primary btn-sm">Primary Button</button>
                        <button class="btn btn-pill btn-outline-secondary btn-sm" type="button"
                            title="btn btn-pill btn-outline-secondary btn-sm">Secondary Button</button>
                        <button class="btn btn-pill btn-outline-success btn-sm" type="button"
                            title="btn btn-pill btn-outline-success btn-sm">Success Button</button>
                        <button class="btn btn-pill btn-outline-info btn-sm" type="button"
                            title="btn btn-pill btn-outline-info btn-sm">Info Button</button>
                        <button class="btn btn-pill btn-outline-warning btn-sm" type="button"
                            title="btn btn-pill btn-outline-warning btn-sm">Warning Button</button>
                        <button class="btn btn-pill btn-outline-danger btn-sm" type="button"
                            title="btn btn-pill btn-outline-danger btn-sm">Danger Button</button>
                        <button class="btn btn-pill btn-outline-light btn-sm txt-dark" type="button"
                            title="btn btn-pill btn-outline-light btn-sm">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code>,<code>.btn-outline-*</code> and <code>.btn-xs</code> class
                            for extra small button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-outline-primary btn-xs" type="button"
                            title="btn btn-pill btn-outline-primary btn-xs">Primary Button</button>
                        <button class="btn btn-pill btn-outline-secondary btn-xs" type="button"
                            title="btn btn-pill btn-outline-secondary btn-xs">Secondary Button</button>
                        <button class="btn btn-pill btn-outline-success btn-xs" type="button"
                            title="btn btn-pill btn-outline-success btn-xs">Success Button</button>
                        <button class="btn btn-pill btn-outline-info btn-xs" type="button"
                            title="btn btn-pill btn-outline-info btn-xs">Info Button</button>
                        <button class="btn btn-pill btn-outline-warning btn-xs" type="button"
                            title="btn btn-pill btn-outline-warning btn-xs">Warning Button</button>
                        <button class="btn btn-pill btn-outline-danger btn-xs" type="button"
                            title="btn btn-pill btn-outline-danger btn-xs">Danger Button</button>
                        <button class="btn btn-pill btn-outline-light btn-xs txt-dark" type="button"
                            title="btn btn-pill btn-outline-light btn-xs">Light Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        </div><span>Add <code>.btn-pill</code> and <code>.btn-*-gradien</code>class for gradien
                            button</span>
                    </div>
                    <div class="card-body common-flex">
                        <button class="btn btn-pill btn-primary-gradien" type="button"
                            title="btn btn-pill btn-primary-gradien">Primary Button</button>
                        <button class="btn btn-pill btn-secondary-gradien" type="button"
                            title="btn btn-pill btn-secondary-gradien">Secondary Button</button>
                        <button class="btn btn-pill btn-success-gradien" type="button"
                            title="btn btn-pill btn-success-gradien">Success Button</button>
                        <button class="btn btn-pill btn-info-gradien" type="button"
                            title="btn btn-pill btn-info-gradien">Info Button</button>
                        <button class="btn btn-pill btn-warning-gradien" type="button"
                            title="btn btn-pill btn-warning-gradien">Warning Button</button>
                        <button class="btn btn-pill btn-danger-gradien" type="button"
                            title="btn btn-pill btn-danger-gradien">Danger Button</button>
                        <button class="btn btn-pill btn-light-gradien txt-dark" type="button"
                            title="btn btn-pill btn-light-gradien">Light Button</button>
                        <div class="code-box-copy">
