                ...
                <div class="left-sidebar-wrapper card">
                    ...
                    <div class="advance-options">
                        <ul class="nav border-tab" id="chat-options-tab" role="tablist">
                            <li class="nav-item"><a class="nav-link active f-w-600" id="chats-tab" data-bs-toggle="tab"
                                    href="#chats" role="tab" aria-controls="chats" aria-selected="true">Chats</a></li>
                            <li class="nav-item"><a class="nav-link f-w-600" id="contacts-tab" data-bs-toggle="tab"
                    ...
                    <div class="right-sidebar-title">
                        <div class="common-space">
                            <div class="chat-time">
                                ...
                                <div><span class="f-w-500">Darrell Steward</span>
                                    <p>Online</p>
                                </div>
                            </div>
