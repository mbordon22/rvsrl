                                    ...
                                    <div class="card-body">
                                        <div class="email-app-sidebar left-bookmark">
                                            ...
                                            <ul class="nav main-menu contact-options" role="tablist">
                                                <li class="nav-item">
                                                    <button class="btn-primary btn-block btn-mail w-100" type="button"
                                                ...
                                                <li><a id="pills-personal-tab" data-bs-toggle="pill"
                                                        href="#pills-personal" role="tab"
                                                        aria-controls="pills-personal" aria-selected="true"><span
                                                            class="title"> Personal</span></a></li>
                                                <li>
                                                    <button class="btn btn-category" type="button"
                                                        data-bs-toggle="modal" data-bs-target="#exampleModal1"><span
                                                            class="title txt-primary f-w-600"> + Add
                                                    ...
                                                    <div class="modal fade" id="exampleModal1" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title" id="exampleModalLabel1">Add
                                                                        Category</h4>
                                                                    <button class="btn-close" type="button"
                                    ...
                                    <div class="tab-pane fade active show" id="pills-personal" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h5 class="f-w-600">Personal</h5><span class="f-14 pull-right mt-0">5
                                                    Contacts</span>
                                            </div>
