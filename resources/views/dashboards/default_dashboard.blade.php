    ...
    <div class="container-fluid">
        <div class="row size-column">
                    ...
                    <div class="card-header sales-chart card-no-border">
                        ...
                        <div class="sales-chart-dropdown">
                            <ul class="balance-data">
                                ...
                                <li> <span class="circle bg-primary"> </span><span class="ms-1 f-w-400">Online Sale</span>
                                </li>
                            </ul>
                        ...
                        <div class="card boost-up-card overflow-hidden">
                            <div class="p-4">
                                ...
                                <div class="img-boostup"><img class="img-boostup-img-1"
                                        src="{{ asset('assets/images/dashboard-3/boostup1.png') }}" alt="boostup"><img
                                        class="img-boostup-img-2"
                                        src="{{ asset('assets/images/dashboard-3/boostup2.png') }}" alt="boostup"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-6">
            ...
            <div class="col-xxl-4 col-md-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue">
                        <h4>Top Product </h4><a href="#">View All </a>
                    </div>
                    <div class="card-body pt-0">
                        <div class="top-product-card">
                            <ul>
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('assets/images/dashboard-3/product/2.png') }}"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78589</span>
                                            </div><a class="f-10 f-w-500  line-clamp" href="#">Noise
                                                - Wireless
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('assets/images/dashboard-3/product/3.png') }}"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78599</span>
                                            </div><a class="f-10 f-w-500  line-clamp" href="#">Men
                                                &amp; Women
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('assets/images/dashboard-3/product/4.png') }}"
                                            alt="product" />
                                    </div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU78596</span>
                                            </div><a class="f-10 f-w-500  line-clamp" href="#">Anime
                                                White Half
                                                Sleev
            ...
            <div class="col-xxl-3 col-sm-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue">
                        <h4>New User </h4><a href="{{ route('admin.user.index') }}">View All</a>
                    </div>

                    <div class="card-body pt-0">
                        <div class="new-user">
                            <ul>
                                @if (count(\App\Helpers\Helpers::getUser()) == 5)
                                    @foreach (\App\Helpers\Helpers::getUser() as $user)
                                        <li>
                                            <div class="space-common d-flex user-name">
                                                <img class="img-40 rounded-circle img-fluid me-2"
                                                    src="{{ asset('assets/images/user/22.png') }}" alt="user" />
                                                <div class="common-space w-100">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14 "
                                                                href="{{ route('admin.user_profile') }}">{{ $user->first_name . ' ' . $user->last_name }}</a>
                                                        </h6>
                                ...
                                @else
                                        ...
                                        <div class="space-common d-flex user-name"><img
                                            ...
                                            <div class="common-space w-100">
                                                <div>
                                                    ...
                                                    </h6><span class="f-light f-w-500 f-12">India</span>
                                                </div>
                                                <div class="product-sub">
                                                    <div class="dropdown">
                                                        <div id="dropdownMenuButtonicon31" data-bs-toggle="dropdown"
                                    ...
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                class="img-40 rounded-circle img-fluid me-2"
                                                src="{{ asset('assets/images/user/28.png') }}" alt="user" />
                                            <div class="common-space w-100">
                                                <div>
                                                    <h6> <a class="f-w-500 f-14 " href="user-profile.html">Robert Fox</a>
                                                    </h6><span class="f-light f-w-500 f-12">Afghanistan</span>
                                                </div>
                                                <div class="product-sub">
                                                    <div class="dropdown">
                                            ...
                                            <div class="common-space w-100">
                                                <div>
                                                    <h6> <a class="f-w-500 f-14 " href="user-profile.html">Darlene
                                                            Robtson</a></h6><span
                                                        class="f-light f-w-500 f-12">Georgia</span>
                                                </div>
                                                <div class="product-sub">
                                                    <div class="dropdown">
                                    ...
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                class="img-40 rounded-circle img-fluid me-2"
                                                src="{{ asset('assets/images/user/24.png') }}" alt="user" />
                                            <div class="common-space w-100">
                                                <div>
                                    ...
                                    <li>
                                        <div class="space-common d-flex user-name"><img
                                                class="img-40 rounded-circle img-fluid me-2"
                                                src="{{ asset('assets/images/user/49.png') }}" alt="user" />
                                            <div class="common-space w-100">
                                                <div>
            ...
            <div class="col-xxl-5 col-sm-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue pb-0">
                        <h4>Team Activity </h4><a href="#">View All </a>
                    </div>
                    <div class="card-body pt-0">
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                src="{{ asset('assets/images/user/50.png') }}"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Floyd Miles</a></div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('assets/images/user/51.png') }}"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Ralph Edwards</a></div>
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Esther Howard</a></div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('assets/images/user/52.png') }}"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Jacob Jones</a></div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('assets/images/user/53.png') }}"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Theresa Webb</a></div>
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('assets/images/user/54.png') }}"
                                                                alt="user"><a class="f-10 f-w-500 username"
                                                                href="{{ route('admin.edit_profile') }}">Annette Black</a></div>
                                                        <div class="activity-time"><span class="f-light f-w-500 f-10">12
                                                                min ago</span></div>
                                                    </div>
                                                    <div class="subtitle">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="common-space">
                            <div><a class="f-w-600 f-14 " href="{{ route('admin.dashboard') }}">Most Visited Day</a><span
            ...
            <div class="col-xxl-5 col-xl-6 box-col-6">
                <div class="card">
                    <div class="card-header card-no-border total-revenue">
                        <h4>Latest Transaction</h4><a href="#">View All</a>
                    </div>
                    <div class="card-body pt-0">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="selling-product">
                            ...
                            <div class="sales-chart-dropdown">
                                <ul class="balance-data">
                                    <li> <span class="circle bg-primary"></span><span class="f-light ms-1">Digital</span>
                                    </li>
                                    <li><span class="circle bg-warning"></span><span class="f-light ms-1">Clothes</span>
                                    </li>
                                    <li> <span class="circle bg-secondary"></span><span
                                            class="f-light ms-1">Electric</span></li>
                                    <li> <span class="circle bg-light"> </span><span class="f-light ms-1">Footwear</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
