                                ...
                                <tbody>
                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td>
                                            <div class="product-names">
                                                <div class="light-product-box"><img class="img-fluid"
                                                        src="{{ asset('assets/images/ecommerce/product-categories/wireless-headphone.png') }}"
                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td>
                                            <div class="product-names">
                                                <div class="light-product-box"><img class="img-fluid"
                                                        src="{{ asset('assets/images/ecommerce/product-categories/ipad.png') }}"
                                                        alt="mac laptop"></div>
                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td>
                                            <div class="product-names">
                                                <div class="light-product-box"><img class="img-fluid"
                                                        src="{{ asset('assets/images/ecommerce/product-categories/mouse.png') }}"
                                                        alt="mouse"></div>
                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td>
                                            <div class="product-names">
                                                <div class="light-product-box"><img class="img-fluid"
                                                        src="{{ asset('assets/images/ecommerce/product-categories/dvd.png') }}"
                                                        alt="DVD"></div>
                                                <p>DVD</p>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td>
                                            <div class="product-names">
                                                <div class="light-product-box"><img class="img-fluid"
                                                        src="{{ asset('assets/images/ecommerce/product-categories/speaker.png') }}"
                                                        alt="speakers"></div>
                                                <p>Speakers</p>
                                            </div>
                                        </td>
