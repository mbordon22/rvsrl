                                ...
                                <div class="prooduct-details-box">
                                    <div class="media"><img class="align-self-center img-fluid img-60"
                                        ...
                                        <div class="media-body ms-3">
                                            ...
                                            </div><a class="btn btn-primary btn-xs" href="#">Processing</a><i
                                ...
                                <div class="prooduct-details-box">
                                    <div class="media"><img class="align-self-center img-fluid img-60"
                                        ...
                                        <div class="media-body ms-3">
                                            ...
                                            <div class="avaiabilty">
                                                <div class="text-success">In stock</div>
                                            </div><a class="btn btn-success btn-xs" href="#">Shipped</a><i
                                                class="close" data-feather="x"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="prooduct-details-box">
                                    <div class="media"><img class="align-self-center img-fluid img-60"
                                        ...
                                        <div class="media-body ms-3">
                                            ...
                                            <div class="avaiabilty">
                                                <div class="text-success">In stock</div>
                                            </div><a class="btn btn-danger btn-xs" href="#">Cancelled</a><i
                                                class="close" data-feather="x"></i>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="order-history table-responsive custom-scrollbar">
                            <table class="table table-bordernone display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/10.png') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/12.png') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/3.png') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/2.png') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/15.png') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/14.png') }}" alt="#"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-30"
                                                src="{{ asset('assets/images/product/11.png') }}" alt="#"></td>
                                        <td>
