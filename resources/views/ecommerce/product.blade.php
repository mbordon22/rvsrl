                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter"><i class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                                ...
                                                <div class="product-box row align-items-center">
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-view">
                                                            ...
                                                            <p class="mb-0">Elevate your casual wardrobe with our Women's
                                                                T-Shirt, a versatile and comfortable addition to your
                                                                everyday style.Crafted from soft and breathable cotton ease
                                                                of movement.</p>
                                                        </div>
                                                        ...
                                                        <div class="product-qnty">
                                                            ...
                                                            <div class="addcart-btn"><a class="btn btn-primary"
                                                                    ...
                                                                    href="{{ route('admin.product_page') }}">View Details</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <p>Stylish co-ord set 2 for women</p>
                                    <div class="product-price">$30.00
                                        <del>$350.00 </del>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <p>Women Full Sleeve Sweatshirt</p>
                                    <div class="product-price">$26.00
                                        <del>$350.00</del>
                                    </div>
                                </div>
                                                ...
                                                <div class="product-box row align-items-center">
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-size">
                                                            <ul>
                                                                <li>
                                                                    <button class="btn btn-light" type="button">M
                                                                    </button>
                                                                </li>
                                                                <li>
                                                                    <button class="btn btn-light"
                        ...
                        <div class="card">
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <p>Stylish co-ord set dress for women</p>
                                    <div class="product-price">$30.00
                                        <del>$350.00</del>
                                    </div>
                                </div>
                                            ...
                                            <div class="modal-header">
                                                <div class="product-box row align-items-center">
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-view">
                                                            <h6 class="f-w-600">Product Details</h6>
                                                            <p class="mb-0">Elevate your casual wardrobe with our
                                                                Women's T-Shirt, a versatile and comfortable addition to
                                                                your everyday style.Crafted from soft and breathable cotton
                                                                ease of movement.</p>
                                                        </div>
                                                        <div class="product-size">
                                                            <ul>
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter17"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter18"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter19"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter20"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter21"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter22"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
                                ...
                                <div class="product-img"><img class="img-fluid"
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter23"><i
                                                        class="icon-eye"></i></button>
                                            </li>
                                            <li>
                                                <button class="btn" type="button"><i
