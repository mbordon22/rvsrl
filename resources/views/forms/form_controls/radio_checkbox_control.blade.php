            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Use the <code>.form-check-input </code>and <code>.form-check-label </code>for checkbox. And
                            filled checkbox used <code>.checkbox-solid-*</code> and bordered checkbox used
                            <code>.checkbox-*</code>.
                        </p>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                                    ...
                                    <div class="form-check checkbox checkbox-primary mb-0">
                                        <input class="form-check-input" id="checkbox-primary-1" type="checkbox"
                                            checked="">
                                        <label class="form-check-label" for="checkbox-primary-1">Primary -
                                    ...
                                    <div class="form-check checkbox checkbox-secondary mb-0">
                                        ...
                                        <label class="form-check-label" for="checkbox-secondary">Secondary -
                                    ...
                                    <div class="form-check checkbox checkbox-success mb-0">
                                        ...
                                        <label class="form-check-label" for="checkbox-primary">Success -
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Use the <code>.form-check-input </code>and <code>.form-check-label </code>for image checkbox.
                        </p>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="card-wrapper border rounded-3 checkbox-checked">
                                        ...
                                        <div class="img-checkbox">
                                            ...
                                            <label class="form-check-label mb-0" for="img-check-1"> <img
                                                    src="{{ asset('assets/images/switch/1.jpg') }}"
                                    ...
                                    <div class="card-wrapper border rounded-3 checkbox-checked">
                                        ...
                                        <div class="img-checkbox">
                                            ...
                                            <label class="form-check-label mb-0" for="img-radio-4"> <img
                                                    src="{{ asset('assets/images/switch/8.jpg') }}"
                                                    alt="rose-tea"></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="card-wrapper border rounded-3 fill-radios h-100 checkbox-checked">
                                    ...
                                    <div class="form-check radio radio-primary">
                                        <input class="form-check-input" id="radio111" type="radio" name="radio3"
                                            value="option1" checked="">
                                        <label class="form-check-label" for="radio111">Product</label>
                                    </div>
                                    <div class="form-check radio radio-warning">
                                        <input class="form-check-input" id="radio333" type="radio" name="radio3"
                                            value="option3">
                                        <label class="form-check-label" for="radio333">Order history </label>
                                    </div>
                                    <div class="form-check radio radio-danger">
                                        <input class="form-check-input" id="radio444" type="radio" name="radio3"
                                            value="option3">
                                        <label class="form-check-label" for="radio444">Invoice </label>
                                    </div>
                                    <div class="form-check radio radio-info">
                                        <input class="form-check-input" id="radio666" type="radio" name="radio3"
                                            value="option3">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Group checkboxes or radios on the same horizontal row by adding <code>.form-check-inline
                            </code>to any<code>.form-check</code>.</p>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6 col-xl-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            The choice between these two approaches will depend on the type of toggle you are creating, and
                            whether or not the toggle will make sense to users when announced as a checkbox or as an actual
                            button. <code>[any one selected]</code>.</p>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            The choice between these two approaches will depend on the type of toggle you are creating, and
                            whether or not the toggle will make sense to users when announced as a checkbox or as an actual
                            button. <code>[multiple selected]</code>.</p>
                    </div>
