                                            ...
                                            <form class="row g-3 needs-validation" novalidate="">
                                                ...
                                                <div class="col-xl-4 col-12">
                                                    ...
                                                    <input class="form-control" id="customEmail" type="email"
                                                        required="" placeholder="Riho@example.com">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                            ...
                                            <form class="row g-3 needs-validation" novalidate="">
                                                <div class="col-sm-6 bank-search">
                                                    <label class="form-label" for="aadharnumber-wizard">Aadhaar
                                                        Number<span class="txt-danger">*</span></label>
                                        ...
                                        <div class="tab-pane fade" id="inquiry-wizard" role="tabpanel"
                                            ...
                                            <form class="row g-3 needs-validation" novalidate="">
                                                <div class="col-12 inquiries-form">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <p class="f-w-500">Select the option how you want to receive
                                                                important notifications.</p>
                                                            <div class="choose-option">
                                                                <div class="form-check radio radio-primary">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="notification1">Featured Items</label>
                                                                </div>
                                                                <div class="form-check radio radio-primary">
                                                                    <input class="form-check-input me-2"
                                                ...
                                                <div class="col-12">
                                                    <section class="main-upgrade">
                                                        <div><i class="fa fa-rocket"></i>
                                                            <h5 class="mb-2">Select team size with <span
                                                                    class="txt-primary">projects</span></h5>
                                            ...
                                            <form class="row g-3 needs-validation" novalidate="">
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label" for="validationCustom-select">Join
                                                        organization type<span class="txt-danger">*</span></label>
                                            ...
                                            <form class="row g-3 needs-validation" novalidate="">
                                                ...
                                                <div class="col-xxl-4 col-md-6">
                                                    ...
                                                    <input class="form-control" id="validation-email-wizard"
                                                        type="email" required="" placeholder="Riho@example.com">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                            ...
                                                            <div class="choose-option">
                                                                <div class="form-check radio radio-primary">
                                                                    <input class="form-check-input me-2" id="radioSelect1"
                                                                        ...
                                                                        value="option1">
                                                                    <label class="form-check-label"
                                                                        for="radioSelect1">Featured Items</label>
                                                                </div>
                                                                <div class="form-check radio radio-primary">
                                                        ...
                                                        <ul class="radio-wrapper">
                                                            ...
                                                            <li>
                                                                <input class="form-check-input" id="radio-icon4"
                                                                    type="radio" name="radio2" value="option2"
                                                                    checked="">
                                                                <label class="form-check-label mb-0" for="radio-icon4"><i
                                                                        class="fa fa-user"></i><span
                                                                        class="d-flex flex-column"><span>Personal
                                                                        </span><span>Search your personal information please
                                                                            check it</span></span></label>
                                        ...
                                        <div class="tab-pane fade" id="business-bank-wizard" role="tabpanel"
                                            ...
                                            <form class="row g-3 needs-validation" novalidate="">
                                                ...
                                                <div class="col-12">
                                                    <section class="main-upgrade">
                                                        <div><i class="fa fa-rocket"></i>
                                                            <h6 class="mb-2">Select team size with <span
                                                                    class="txt-primary">projects</span></h6>
