    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>1</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>2</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>3</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>4</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>5</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>6</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>7</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>9</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>10</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>11</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>13</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>14</span></h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Hover Effect <span>15</span></h4>
                    </div>
                    <div class="card-body">
