    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0"><span>20</span> Icons</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">Currency Icons</h4>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">Form Control Icons</h4>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-check-square"></i> fa-check-square
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">Text Editor Icons</h4>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">Video Player Icons</h4>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
                            <div class="col-sm-6 col-md-4 col-xl-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="m-b-0">Medical Icons</h4>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists">
