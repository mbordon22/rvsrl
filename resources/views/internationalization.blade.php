            ...
            <div class="col-lg-12">
                <div class="site">
                    <div class="site-bd">
                        <div class="wrapper">
                            <div class="card">
                                <div class="card-header language-header card-no-border">
                                    <h4>Internationalization </h4>
                                    <div class="main" role="main">
                                        <select class="langChoice js-languageSelect bg-primary">
                                ...
                                <div class="card-body row">
                                    <div class="col-sm-6">
                                        <h5 class="hdg hdg_main js-languagePageHdg mb-3">Static Sub Nav</h5>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>How to use it</h4><span>Add a class<code>.hdg, .hdg_main, .js-languagePageHdg, .hList,
                                .hList_loose, .masthead-nav., js-languageList, .langChoice, .js-languageSelect</code>class
                            to any tag for language translate</span>
                    </div>
                    <div class="card-body">
                        <div class="language">
