                                        ...
                                        <div class="collapse show" id="collapseicon2" data-bs-parent="#accordion"
                                            ...
                                            <div class="card-body animate-chk">
                                                ...
                                                <label class="d-block" for="chk-ani12">
                                                    <input class="checkbox_animated" id="chk-ani12" type="checkbox"> PHP
                                                    developer(42)
                                                </label>
                                        ...
                                        <div class="collapse show" id="collapseicon3" data-bs-parent="#accordion"
                                            ...
                                            <div class="card-body animate-chk">
                                                ...
                                                <label class="d-block" for="chk-ani15">
                                                    <input class="checkbox_animated" id="chk-ani15" type="checkbox"> IT
                                                    Engineer(10)
                                                </label>
                                        ...
                                        <div class="collapse show" id="collapseicon4" data-bs-parent="#accordion"
                                            ...
                                            <div class="card-body animate-chk">
                                                ...
                                                <label class="d-block" for="chk-ani22">
                                                    <input class="checkbox_animated" id="chk-ani22" type="checkbox"> Gulp
                                                    & Pug
                                                </label>
                ...
                <div class="card">
                    <div class="job-search">
                        <div class="card-body">
                            ...
                            <p>
                                We are looking for an experienced and Riho designer and/or frontend engineer with expertise
                    ...
                    <div class="job-search">
                        <div class="card-body">
                            <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="f-w-600"><a href="#">Graphic designer</a><span class="pull-right">3
                                            days ago</span></h6>
                    ...
                    <div class="job-search">
                        <div class="card-body">
                            <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="f-w-600"><a href="#">Designer, CRM</a><span class="pull-right">3
                                            days ago</span></h6>
                    ...
                    <div class="job-search">
                        <div class="card-body">
                            <div class="d-flex"><img class="img-40 img-fluid m-r-20"
                                    src="{{ asset('assets/images/job-search/2.jpg') }}" alt="">
                                <div class="flex-grow-1">
                                    <h6 class="f-w-600"><a href="#">UI designer E-commerce</a><span
