...
@section('main_content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-9 xl-60 order-xl-0 order-1 box-col-12 card">
                <div class="blog-single card-body">
                    <div class="blog-box blog-details"><img class="img-fluid w-100"
                        ...
                        <div class="blog-details">
                            ...
                            <div class="single-blog-content-top">
                                <p>Knowledge can be defined as awareness of facts or as practical skills, and may also refer
                                    to familiarity with objects or situations. Knowledge of facts, also called propositional
                                    knowledge, is often defined as true belief that is distinct from opinion or guesswork by
                                    virtue of justification. While there is wide agreement among philosophers that it is a
                                    form of true belief, many controversies in philosophy focus on justification: whether it
                                    is needed at all, how to understand it, and whether something else besides it is needed.
                                </p>
                                <p>
                                    Knowledge can be produced in many different ways. The most important source is
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-md-4 xl-100">
                                                <h6 class="mt-0">
                                                    Jolio Mark<span> ( Designer )</span></h6>
                                            </div>
                            ...
                            <li>
                                <div class="media"> <img class="align-self-center"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>
                                            Clean resort with maintained garden but rooms are average Lack of communication
                                        ...
                                        <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                                            ...
                                            <div class="upcoming-course card-body">
                                                <div class="media common-space">
                                                    <div class="media-body"><span class="f-w-600">UX
                                                            Development</span><span class="d-block">Course By <a
                                                                class="f-w-500" href="#">Development
                                                ...
                                                <div class="media common-space">
                                                    <div class="media-body"><span class="f-w-600">Business
                                                            Analyst</span><span class="d-block">Course By <a
                                                                class="f-w-500" href="#">Analyst
                                                                Team</a></span><span class="d-block"><i
                                                                class="fa fa-star font-warning"></i><i
                                                                class="fa fa-star font-warning"></i><i
                                                                class="fa fa-star font-warning"></i><i
                                                ...
                                                <div class="media common-space">
                                                    <div class="media-body"><span class="f-w-600">Web
                                                            Development</span><span class="d-block">Course By <a
                                                                class="f-w-500" href="#">Designer</a></span><span
