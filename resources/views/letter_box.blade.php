                                    ...
                                    <div class="mail-body-wrapper">
                                        <ul>
                                            <li class="inbox-data">
                                                ...
                                                <div class="inbox-message">
                                                    <div class="email-data"><span>Confirm your booking id -<span>craft
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body compose-modal">
                                    <form>
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="composeFrom">From
                                                :</label>
                                            <div class="col-sm-10">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="row g-sm-3 g-2 custom-input">
                                            <label class="col-sm-2 col-form-label" for="Label_Modal">Label
                                                Name :</label>
                                            <div class="col-sm-10">
