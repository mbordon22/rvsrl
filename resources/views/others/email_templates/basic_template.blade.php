                    ...
                    <table style="margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr class="logo-sec" style="display: flex; align-items: center; justify-content: space-between; width: 650px;">
                          <td><img class="img-fluid" src="{{ asset('assets/images/other-images/logo-login.png') }}" alt=""></td>
                      ...
                      <tbody>
                        <tr>
                          <td style="padding: 30px"> 
                            ...
                            <div class="text-center"><a href="{{ route('admin.contacts') }}" style="padding: 10px; background-color: #006666; color: #fff; display: inline-block; border-radius:30px; margin-bottom:18px; font-weight:600; padding:0.6rem 1.75rem;">Call To Action </a></div>
                      ...
                      <tbody>       
                        <tr style="text-align: center">
                          <td> 
                            ...
                            <p style="color: #999; margin-bottom: 0">Don't Like These Emails?<a href="#" style="color: #006666">Unsubscribe</a></p>
                            <p style="color: #999; margin-bottom: 0">Powered By Riho Admin</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
