                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px">
                                    ...
                                    <p>you forgot your password for Riho Admin. If this is true, click below to reset
                                        your password.</p>
                                    <p style="text-align: center"><a href="{{ route('admin.reset_password') }}"
                                            style="padding: 10px; background-color:#006666; color: #fff; display: inline-block; border-radius:30px; font-weight:700; padding:0.6rem 1.75rem;">Reset
                                            Password</a></p>
                            ...
                            <tr style="text-align: center">
                                <td>
                                    ...
                                    <p style="color: #999; margin-bottom: 0">Don't Like These Emails?<a href="#"
                                            style="color: #006666">Unsubscribe </a></p>
