                    ...
                    <tbody>
                        <tr class="header">
                            <td align="left" valign="top"><img class="main-logo"
                                    src="{{ asset('assets/images/other-images/logo-login.png') }}"></td>
                ...
                <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <tbody>
                        ...
                        <tr class="add-with-banner" align="center">
                            ...
                            <td>
                                <div style="border-top:1px solid #006666; mso-line-height-rule: exactly;"
                                ...
                                <div style="border-bottom:1px solid #006666; mso-line-height-rule: exactly;"
                                ...
                                <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tbody>
                                        <tr class="temp-social">
                                            <td><a href="#"><img
                                                        src="{{ asset('assets/images/email-template/facebook.png') }}"
                                                        alt=""></a></td>
                                            <td><a href="#"><img
                                                        src="{{ asset('assets/images/email-template/youtube.png') }}"
                                                        alt=""></a></td>
                                            <td><a href="#"><img
                                                        src="{{ asset('assets/images/email-template/twitter.png') }}"
                                                        alt=""></a></td>
                                            <td><a href="#"><img
                                                        src="{{ asset('assets/images/email-template/gplus.png') }}"
                                                        alt=""></a></td>
                                            <td><a href="#"><img
                                                        src="{{ asset('assets/images/email-template/linkedin.png') }}"
                                                        alt=""></a></td>
                                            <td><a href="#"><img
                                                        src="{{ asset('assets/images/email-template/pinterest.png') }}"
                                                        alt=""></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="javascript:void(0)"
                                                    style="color: #006666;font-size:14px;text-transform: capitalize;font-weight:600;">Want
                                                    to change how you receive these emails?</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p style="font-size:14px; margin:8px 0; color:#717171;">2022 - 23 Copy
                                                    Right by Themeforest powerd by Pixel Strap</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><a href="javascript:void(0)"
                                                    style="color: #006666;font-size: 14px;text-transform: capitalize;font-weight:600; margin:0;">Unsubscribe</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
