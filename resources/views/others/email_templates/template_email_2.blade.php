...
<head>
  ...
  <meta name="description" content="Riho admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
      ...
      <tr> 
        <td>
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
              <tr class="header">
                <td align="left" valign="top"><img class="main-logo" src="{{ asset('assets/images/logo/logo_dark.png') }}"></td>
          ...
          <table class="slider" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
              <tr>
                ...
                <th width="60%" style="background-color: #006666; padding: 30px;">
                  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                      <tr>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        <td class="text-button white-button" style="font-size:14px; line-height:18px; text-align:center; text-transform:uppercase; padding:0.6rem 1.75rem; background:#ffffff; color: #006666; font-weight:bold; border-radius:30px;"><a href="javascript:void(0)" target="_blan" style="color:#4e54cb; text-decoration:none;"><span style="color: #006666; text-decoration:none;">shop now</span></a></td>
                      </tr>
                    </tbody>
                  </table>
                </th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td align="center" style="background-color: #fafafa;width: 60%; border-top-right-radius:10px; padding: 12px;">
                          ...
                          <div style="color: #006666; font-weight:600; font-size:16px; line-height:27px; letter-spacing:1px;margin: 4px;"><span class="txt-price1" style="color:#666666; font-weight:600; font-size:15px; line-height:25px; letter-spacing:1px;" data-color="Price1" data-size="Price1" data-min="10" data-max="35">
                              <strike>$25.00</strike></span><span class="txt-price2">   </span>$20.90</div>
                          <div style="padding: 15px 0px;text-transform: uppercase;font-size: 11px;letter-spacing: 1px;"><a href="javascript:void(0)" style="color: #ffffff;text-decoration:none; border-radius:10px;; background: #006666; padding: 8px 12px;">SHOP NOW</a></div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr>
                <td style="padding: 30px;">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                    <tbody>
                      <tr>
                        <td><a href="javascript:void(0)" style="color:  #006666;font-size:14px;text-transform: capitalize;font-weight:600;">Want to change how you receive these emails?</a></td>
                      </tr>
                      <tr>
                        <td> 
                          <p style="font-size:14px; margin:8px 0; color:#717171;">2022 - 23 Copy Right by Themeforest powerd by Pixel Strap</p>
                        </td>
                      </tr>
                      <tr>
                        <td><a href="javascript:void(0)" style="color:  #006666;font-size: 14px;text-transform: capitalize;font-weight:600; margin:0;">Unsubscribe</a></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
