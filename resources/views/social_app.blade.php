                            ...
                            <div class="default-according style-1 faq-accordion" id="accordionExample">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-start f-w-600" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                                aria-expanded="true" aria-controls="collapseOne">My Profile</button>
                                        </h2>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-start f-w-600 collapsed"
                                    ...
                                    <div class="collapse show" id="collapseTwo" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body social-status filter-cards-view">
                                            ...
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                ...
                                                <div class="flex-grow-1"><span class="f-w-600 d-block">Sarah
                                            ...
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                ...
                                                <div class="flex-grow-1"><span class="f-w-600 d-block">Jason
                                            ...
                                            <div class="d-flex"><img class="img-50 rounded-circle m-r-15"
                                                ...
                                                <div class="social-status social-online"></div>
                                                <div class="flex-grow-1"><span class="f-w-600 d-block">Andew
                                        ...
                                        <div class="card-body">
                                            <div class="new-users-social">
                                                <div class="d-flex align-items-center"><img
                                                        class="rounded-circle image-radius m-r-15 img-50"
                                                        src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="timeline-content">
                                                <p>
                                                    The only way to do something in depth is to work hard. I've always
                                                    thought of the T-shirt as the Alpha of the fashion alphabet.
                                                    My breakfast is very important. Everything I do is a matter of heart,
                                                    body and soul.
                                                </p>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="timeline-content">
                                                <p>
                                                    I've always thought of the T-shirt as the Alpha of the fashion alphabet.
                                                    My breakfast is very important. Everything I do is a matter of heart,
                                                    body and soul.
                        ...
                        <div class="col-xl-6 xl-60 col-lg-12 col-md-8 box-col-8e">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header">
                                            <h4>Hobbies and Interests<span class="pull-right"><i
                                                        data-feather="more-vertical"></i></span></h4>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="row details-about">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="your-details your-details-xs"><span
                                                        ...
                                                        <p>Swimming, Surfing, SRiho Diving, Anime, Photography, Tattoos,
                                                            Street Art.</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header">
                                            <h4>Education and Employement<span class="pull-right"><i
                                                        data-feather="more-vertical"></i></span></h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="row details-about">
                                    ...
                                    <div class="col-xl-12 xl-50 box-col-6">
                                        <div class="card">
                                            ...
                                            <div class="collapse show" id="collapseicon2"
                                                aria-labelledby="collapseicon7" data-bs-parent="#accordion">
                                                <div class="card-body filter-cards-view"><span
                                                        class="f-w-600 mb-2 d-block">About Me :</span>
                                                    <p>
                                                        Hi, I’m elana, I’m 30 and I work as a
                                                ...
                                                <div class="card-body social-list filter-cards-view">
                                                    ...
                                                    <div class="d-flex"><img
                                                        ...
                                                        <div class="flex-grow-1"><span class="d-block">Andew
                                                                Jon</span><a href="#">Add Friend</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="social-img-wrap">
                                        <div class="social-img"><img
                                                src="{{ asset('assets/images/dashboard-3/profile.png') }}"
                                                alt="profile"></div>
                                        <div class="edit-icon">
                                            <svg>
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Brooklyn Simmons</a>
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1 f-w-600"><a href="{{ route('admin.social_app') }}">Mark Jecno</a>
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Dev John</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Johan Deo</a></h5><span
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Douglas Reichel</a>
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Lisa lillian</a></h5>
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Olivia rose</a></h5>
                        ...
                        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                            <div class="card social-profile">
                                <div class="card-body">
                                    ...
                                    <div class="social-details">
                                        <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Sarah Karen</a></h5>
