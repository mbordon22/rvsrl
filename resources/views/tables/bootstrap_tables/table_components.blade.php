                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="alert alert-primary">
                                                        <p><strong>Success!</strong> You should <a class="alert-link font-secondary"
                                                                href="#">read this message</a>.</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p><span>Alerts are available for any length of text, as well as an
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span>Wrap with use<code>disabled</code>,<code>primary, secondary,
                                                            success, info, warning, danger</code>for this style of checkbox
                                                        disable.</span></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table-bordered radio-first-col-width">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="radio radio-primary">
                                                        <input id="radio44" type="radio" name="radio1"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="radio radio-primary">
                                                        <input id="radio33" type="radio" name="radio1"
