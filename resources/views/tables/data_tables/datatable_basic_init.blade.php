                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action"> <a class="pdf"
                                                href="{{ asset('assets/pdf/sample.pdf') }}" target="_blank"><i
                                                    class="icofont icofont-file-pdf"> </i></a></td>
                                        <td> <span class="badge rounded-pill badge-success">hired</span></td>
                                ...
                                <tbody>
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Tiger
                                            Nixon</td>
                                        <td>System Architect</td>
                                        <td>Edinburgh</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Garrett
                                            Winters</td>
                                        <td>Accountant</td>
                                        <td>Tokyo</td>
                                        <td>63</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Ashton Cox
                                        </td>
                                        <td>Junior Technical Author</td>
                                        <td>San Francisco</td>
                                        <td>66</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Cedric
                                            Kelly</td>
                                        <td>Senior Javascript Developer</td>
                                        <td>Edinburgh</td>
                                        <td>22</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Airi Satou
                                        </td>
                                        <td>Accountant</td>
                                        <td>Tokyo</td>
                                        <td>33</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Brielle
                                            Williamson</td>
                                        <td>Integration Specialist</td>
                                        <td>New York</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Herrod
                                            Chandler</td>
                                        <td>Sales Assistant</td>
                                        <td>San Francisco</td>
                                        <td>59</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Rhona
                                            Davidson</td>
                                        <td>Integration Specialist</td>
                                        <td>Tokyo</td>
                                        <td>55</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Colleen
                                            Hurst</td>
                                        <td>Javascript Developer</td>
                                        <td>San Francisco</td>
                                        <td>39</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Sonya
                                            Frost</td>
                                        <td>Software Engineer</td>
                                        <td>Edinburgh</td>
                                        <td>23</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Jena
                                            Gaines</td>
                                        <td>Office Manager</td>
                                        <td>London</td>
                                        <td>30</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Quinn
                                            Flynn</td>
                                        <td>Support Lead</td>
                                        <td>Edinburgh</td>
                                        <td>22</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Charde
                                            Marshall</td>
                                        <td>Regional Director</td>
                                        <td>San Francisco</td>
                                        <td>36</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Haley
                                            Kennedy</td>
                                        <td>Senior Marketing Designer</td>
                                        <td>London</td>
                                        <td>43</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Tatyana
                                            Fitzpatrick</td>
                                        <td>Regional Director</td>
                                        <td>London</td>
                                        <td>19</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Michael
                                            Silva</td>
                                        <td>Marketing Designer</td>
                                        <td>London</td>
                                        <td>66</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Paul Byrd
                                        </td>
                                        <td>Chief Financial Officer (CFO)</td>
                                        <td>New York</td>
                                        <td>64</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Gloria
                                            Little</td>
                                        <td>Systems Administrator</td>
                                        <td>New York</td>
                                        <td>59</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Bradley
                                            Greer</td>
                                        <td>Software Engineer</td>
                                        <td>London</td>
                                        <td>41</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Dai Rios
                                        </td>
                                        <td>Personnel Lead</td>
                                        <td>Edinburgh</td>
                                        <td>35</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Jenette
                                            Caldwell</td>
                                        <td>Development Lead</td>
                                        <td>New York</td>
                                        <td>30</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Yuri Berry
                                        </td>
                                        <td>Chief Marketing Officer (CMO)</td>
                                        <td>New York</td>
                                        <td>40</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Caesar
                                            Vance</td>
                                        <td>Pre-Sales Support</td>
                                        <td>New York</td>
                                        <td>21</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Doris
                                            Wilder</td>
                                        <td>Sales Assistant</td>
                                        <td>Sidney</td>
                                        <td>23</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Angelica
                                            Ramos</td>
                                        <td>Chief Executive Officer (CEO)</td>
                                        <td>London</td>
                                        <td>47</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Gavin
                                            Joyce</td>
                                        <td>Developer</td>
                                        <td>Edinburgh</td>
                                        <td>42</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Jennifer
                                            Chang</td>
                                        <td>Regional Director</td>
                                        <td>Singapore</td>
                                        <td>28</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Brenden
                                            Wagner</td>
                                        <td>Software Engineer</td>
                                        <td>San Francisco</td>
                                        <td>28</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Fiona
                                            Green</td>
                                        <td>Chief Operating Officer (COO)</td>
                                        <td>San Francisco</td>
                                        <td>48</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Shou Itou
                                        </td>
                                        <td>Regional Marketing</td>
                                        <td>Tokyo</td>
                                        <td>20</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Michelle
                                            House</td>
                                        <td>Integration Specialist</td>
                                        <td>Sidney</td>
                                        <td>37</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Suki
                                            Burks</td>
                                        <td>Developer</td>
                                        <td>London</td>
                                        <td>53</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Prescott
                                            Bartlett</td>
                                        <td>Technical Author</td>
                                        <td>London</td>
                                        <td>27</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Martena
                                            Mccray</td>
                                        <td>Post-Sales support</td>
                                        <td>Edinburgh</td>
                                        <td>46</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Unity
                                            Butler</td>
                                        <td>Marketing Designer</td>
                                        <td>San Francisco</td>
                                        <td>47</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Howard
                                            Hatfield</td>
                                        <td>Office Manager</td>
                                        <td>San Francisco</td>
                                        <td>51</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Hope
                                            Fuentes</td>
                                        <td>Secretary</td>
                                        <td>San Francisco</td>
                                        <td>41</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Timothy
                                            Mooney</td>
                                        <td>Office Manager</td>
                                        <td>London</td>
                                        <td>37</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Jackson
                                            Bradshaw</td>
                                        <td>Director</td>
                                        <td>New York</td>
                                        <td>65</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Olivia
                                            Liang</td>
                                        <td>Support Engineer</td>
                                        <td>Singapore</td>
                                        <td>64</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Bruno
                                            Nash</td>
                                        <td>Software Engineer</td>
                                        <td>London</td>
                                        <td>38</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Sakura
                                            Yamamoto</td>
                                        <td>Support Engineer</td>
                                        <td>Tokyo</td>
                                        <td>37</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Thor
                                            Walton</td>
                                        <td>Developer</td>
                                        <td>New York</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Finn
                                            Camacho</td>
                                        <td>Support Engineer</td>
                                        <td>San Francisco</td>
                                        <td>47</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Serge
                                            Baldwin</td>
                                        <td>Data Coordinator</td>
                                        <td>Singapore</td>
                                        <td>64</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Zenaida
                                            Frank</td>
                                        <td>Software Engineer</td>
                                        <td>New York</td>
                                        <td>63</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Zorita
                                            Serrano</td>
                                        <td>Software Engineer</td>
                                        <td>San Francisco</td>
                                        <td>56</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Jennifer
                                            Acosta</td>
                                        <td>Junior Javascript Developer</td>
                                        <td>Edinburgh</td>
                                        <td>43</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Cara
                                            Stevens</td>
                                        <td>Sales Assistant</td>
                                        <td>New York</td>
                                        <td>46</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="">Hermione
                                            Butler</td>
                                        <td>Regional Director</td>
                                        <td>London</td>
                                        <td>47</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="">Lael
                                            Greer</td>
                                        <td>Systems Administrator</td>
                                        <td>London</td>
                                        <td>21</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Jonas
                                            Alexander</td>
                                        <td>Developer</td>
                                        <td>San Francisco</td>
                                        <td>30</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt="">Shad
                                            Decker</td>
                                        <td>Regional Director</td>
                                        <td>Edinburgh</td>
                                        <td>51</td>
                                    ...
                                    <tr>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt="">Donna
                                            Snider</td>
                                        <td>Customer Support</td>
                                        <td>New York</td>
                                        <td>27</td>
