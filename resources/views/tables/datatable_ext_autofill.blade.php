    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4 class="mb-3">Multi-Level Collections</h4><span>
                    ...
                    <div class="card-body">
                        <div class="dt-ext table-responsive custom-scrollbar custom-scrollbar">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4 class="mb-3">Header and Footer fixed</h4><span>When displaying tables with a particularly
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt="profile"></td>
                                        <td>61</td>
                                        <td>2011/04/25</td>
                                        <td>$320,800</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Accountant</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.png') }}" alt=""></td>
                                        <td>63</td>
                                        <td>2011/07/25</td>
                                        <td>$170,750</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Senior Javascript Developer</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/2.jpg') }}" alt=""></td>
                                        <td>22</td>
                                        <td>2012/03/29</td>
                                        <td>$433,060</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Accountant</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/3.jpg') }}" alt=""></td>
                                        <td>33</td>
                                        <td>2008/11/28</td>
                                        <td>$162,700</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Integration Specialist</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/3.png') }}" alt=""></td>
                                        <td>61</td>
                                        <td>2012/12/02</td>
                                        <td>$372,000</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Sales Assistant</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/6.jpg') }}" alt="profile"></td>
                                        <td>59</td>
                                        <td>2012/08/06</td>
                                        <td>$137,500</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Integration Specialist</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/7.jpg') }}" alt="profile"></td>
                                        <td>55</td>
                                        <td>2010/10/14</td>
                                        <td>$327,900</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Javascript Developer</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/9.jpg') }}" alt="profile"></td>
                                        <td>39</td>
                                        <td>2009/09/15</td>
                                        <td>$205,500</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Software Engineer</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/10.jpg') }}" alt="profile"></td>
                                        <td>23</td>
                                        <td>2008/12/13</td>
                                        <td>$103,600</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Office Manager</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/11.png') }}" alt="profile"></td>
                                        <td>30</td>
                                        <td>2008/12/19</td>
                                        <td>$90,560</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Support Lead</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt="profile"></td>
                                        <td>22</td>
                                        <td>2013/03/03</td>
                                        <td>$342,000</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Regional Director</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/14.png') }}" alt="profile"></td>
                                        <td>36</td>
                                        <td>2008/10/16</td>
                                        <td>$470,600</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Regional Director</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/1.jpg') }}" alt=""></td>
                                        <td>19</td>
                                        <td>2010/03/17</td>
                                        <td>$385,750</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Chief Marketing Officer (CMO)</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/9.jpg') }}" alt=""></td>
                                        <td>40</td>
                                        <td>2009/06/25</td>
                                        <td>$675,000</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Software Engineer</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/6.jpg') }}" alt=""></td>
                                        <td>28</td>
                                        <td>2011/06/07</td>
                                        <td>$206,850</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Chief Operating Officer (COO)</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/12.png') }}" alt=""></td>
                                        <td>48</td>
                                        <td>2010/03/11</td>
                                        <td>$850,000</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Regional Marketing</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/14.png') }}" alt=""></td>
                                        <td>20</td>
                                        <td>2011/08/14</td>
                                        <td>$163,000</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Post-Sales support</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/10.jpg') }}" alt=""></td>
                                        <td>46</td>
                                        <td>2011/03/09</td>
                                        <td>$324,050</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Support Engineer</td>
                                        <td> <img class="img-fluid table-avtar"
                                                src="{{ asset('assets/images/user/7.jpg') }}" alt=""></td>
                                        <td>64</td>
                                        <td>2011/02/03</td>
                                        <td>$234,500</td>
                                        <td>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4 class="mb-3">Immediately Show Hidden Details</h4><span>Responsive has the ability to display
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4 class="mb-3">Full row selection</h4><span>The rowReorder.selector option provides the
