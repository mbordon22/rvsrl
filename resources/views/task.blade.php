                                        ...
                                        <div class="email-app-sidebar left-bookmark task-sidebar">
                                            ...
                                            <ul class="nav main-menu" role="tablist">
                                                <li class="nav-item">
                                                    <button class="badge-primary btn-block btn-mail w-100" type="button"
                                                        data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                                            class="me-2" data-feather="check-circle"></i> New Task
                                                    </button>
                                                </li>
                                                ...
                                                <li><a class="show" id="pills-weekly-tab" data-bs-toggle="pill"
                                                        ...
                                                        aria-selected="false"><span class="title">This week
                                                            tasks</span></a></li>
                                                <li><a class="show" id="pills-monthly-tab" data-bs-toggle="pill"
                                                        href="#pills-monthly" role="tab" aria-controls="pills-monthly"
                                                        aria-selected="false"><span class="title">This month
                                                            tasks</span></a></li>
                                                <li><a class="show" id="pills-assigned-tab" data-bs-toggle="pill"
                                                        href="#pills-assigned" role="tab"
                                                        aria-controls="pills-assigned" aria-selected="false"><span
                                                            class="title">Assigned to me</span></a>
                                                </li>
                            ...
                            <div class="ps-0">
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="pills-created" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h4 class="mb-0 f-w-600">Created by me</h4><a href="#"><i
                                                    ...
                                                    <div class="table-responsive custom-scrollbar">
                                                        <table class="table">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Gather all necessary potential
                                                                        questions your client might ask.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                                        href="#"><i
                                                                            data-feather="more-horizontal"></i></a></td>
                                                                <td><a href="#"><i data-feather="trash-2"></i></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Begin with introductions and a
                                                                        brief friendly and comfortable atmosphere.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                                        href="#"><i
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Listen actively to your client's
                                                                        thoughts, feedback, and concerns and their needs.
                                                                    </p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">After the meeting, send a
                                                                        follow-up email points discussed and any action
                                                                        items.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Assign someone to details and
                                                                        action items.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Explain concepts ,
                                                                        straightforward language. confuse your client.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                                        href="#"><i
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Start the for your client's time
                                                                        and demonstrate professionalism.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"> </i></a><a
                                                                        href="#"> <i data-feather="more-horizontal">
                                                                        </i></a></td>
                                                                <td><a href="#"> <i data-feather="trash-2"></i></a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="task_desc_0">Clearly define What do you want
                                                                        to achieve during this interaction.</p>
                                                                </td>
                                                                <td><a class="me-2" href="#"><i
                                                                            data-feather="link"></i></a><a
                                                                        href="#"><i
                                    ...
                                    <div class="fade tab-pane" id="pills-weekly" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h6 class="mb-0">This Week Tasks</h6><a href="#"><i
                                                        class="me-2" data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="details-bookmark text-center"><span>No tasks found.</span>
                                    ...
                                    <div class="fade tab-pane" id="pills-monthly" role="tabpanel"
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header d-flex">
                                                <h6 class="mb-0">This Month Tasks</h6><a href="#"><i
                                                        class="me-2" data-feather="printer"></i>Print</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="details-bookmark text-center"><span>No tasks found.</span>
                        ...
                        <form class="form-bookmark needs-validation" id="bookmark-form" novalidate="">
                            <div class="row">
                                <div class="mb-3 mt-0 col-md-12">
                                    ...
                                    <input class="form-control" id="task-title" type="text" required=""
                                        autocomplete="off">
                                </div>
                                <div class="mb-3 mt-0 col-md-12">
                                    <label for="sub-task">Sub task</label>
                                    <input class="form-control" id="sub-task" type="text" required=""
                                        autocomplete="off">
                                </div>
                                <div class="mb-3 mt-0 col-md-12">
