            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Use the <code>.bg-* </code>and <code>.alert-light-* </code>colors in Riho theme. Use of any
                            components.</p>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-xl-4 col-sm-6">
                                <div class="border-wrapper h-100 border">
                                    <h6 class="mb-3">Dark background</h6>
                                    <div class="helper-common-box">
