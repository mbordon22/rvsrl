    ...
    <div class="container-fluid">
        <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="exampleFormControlInput1"
                                                            type="email" placeholder="Rihotheme@gmail.com">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Riho custom modals </h4>
                        <p class="f-m-light mt-1">
                            Custom Modal make by Riho.</p>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                                ...
                                <div class="card-wrapper border rounded-3 h-100">
                                    <div class="Riho-demo-img">
                                        ...
                                        <div class="title-wrapper pb-3 modal-heading">
                                            ...
                                            <p>Example of Riho dashboard profile card.</p>
                                        </div>
                                                        ...
                                                        <div class="card social-profile mb-0">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="social-details">
                                                                    <h5 class="mb-1"><a
                                                                            href="{{ route('admin.social_app') }}">Brooklyn
                                                                            Simmons</a></h5><span
                                ...
                                <div class="card-wrapper border rounded-3 h-100">
                                    <div class="Riho-demo-img">
                                        ...
                                        <div class="title-wrapper pb-3 modal-heading">
                                            ...
                                            <p>Example of Riho login form.</p>
                                        </div>
                                        <div class="overflow-hidden"><img class="img-fluid"
                                ...
                                <div class="card-wrapper border rounded-3 h-100">
                                    <div class="Riho-demo-img">
                                        ...
                                        <div class="title-wrapper pb-3 modal-heading">
                                            ...
                                            <p>Example of Riho dashboard balance card.</p>
                                        </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="balance-profile">
                                                                    <div class="balance-img"><img
                                                                            src="{{ asset('assets/images/dashboard-3/user.png') }}"
