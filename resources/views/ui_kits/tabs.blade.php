                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 col-xs-12">
                                <div class="nav flex-column nav-pills nav-success" id="ver-pills-tabes" role="tablist"
                ...
                <div class="card height-equal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-contactus1" role="tabpanel"
                            ...
                            <div class="tab-pane fade show active" id="pills-blog1" role="tabpanel"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div
                            ...
                            <p> <em class="txt-danger">Riho Profiles For New Employees:</em></p>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="mt-1 f-m-light">Use the <code>.nav-link </code>with <code>.active </code>class through
                            jump another tabs.And <code>aria-orientation='vertical'</code>through change vertical tabs.</p>
                    </div>
                    <div class="card-body">
