                ...
                <div class="card social-profile">
                    <div class="card-body">
                        <div class="social-img-wrap">
                            <div class="social-img"><img src="{{ asset('assets/images/dashboard-3/profile.png') }}"
                                    alt="profile">
                            </div>
                            <div class="edit-icon">
                                <svg>
                        ...
                        <div class="social-details">
                            <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Brooklyn Simmons</a></h5><span
            ...
            <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                <div class="card social-profile">
                    <div class="card-body">
                        ...
                        <div class="social-details">
                            <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Mark Jecno</a></h5><span
            ...
            <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                <div class="card social-profile">
                    <div class="card-body">
                        ...
                        <div class="social-details">
                            <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Douglas Reichel</a></h5><span
            ...
            <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                <div class="card social-profile">
                    <div class="card-body">
                        ...
                        <div class="social-details">
                            <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Lisa lillian</a></h5><span
            ...
            <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                <div class="card social-profile">
                    <div class="card-body">
                        ...
                        <div class="social-details">
                            <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Olivia rose</a></h5><span
            ...
            <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                <div class="card social-profile">
                    <div class="card-body">
                        ...
                        <div class="social-details">
                            <h5 class="mb-1"><a href="{{ route('admin.social_app') }}">Sarah Karen</a></h5><span
